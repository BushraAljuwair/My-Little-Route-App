...
void editParentPrfileBottomsheet({required BuildContext context}) async {
  final bloc = context.read<ParentProfileBloc>();
  bloc.controllerEmail.text = bloc.appGetit.user!.email;

  bloc.controllerPhone.text = bloc.appGetit.user!.phone;
  bloc.controllerName.text = bloc.appGetit.user!.name;
